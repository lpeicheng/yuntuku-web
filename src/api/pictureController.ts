...
/** download POST /api/picture/download */
...
/** searchPictureVOByES POST /api/picture/search/page/vo */
export async function searchPictureVoByEsUsingPost(
  body: API.PictureEsDTO,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/search/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
